...
if __name__ == "__main__":
    ...
    if rank == 0:
        print("FFT of rho field computed...")
    ...
    k_mesh = (k_x_mesh**2 + k_y_mesh**2 + k_z_mesh**2 + 1.0e-20 + 1.0e-20j) ** 0.5
    k_mesh = k_mesh.astype(complex)
    k2_mesh = k_x_mesh**2 + k_y_mesh**2 + k_z_mesh**2 + 1.0e-20 + 1.0e-20j
    ...
    if rank == 0:
        print("FFT of Phi field computed...")
    ...
    if rank == 0:
        cla_total.write_to_hdf5(
            "web_grid_R" + rr_str + "_512_z" + zz_str + "_lth" + ll_str + ".hdf5"
        )
